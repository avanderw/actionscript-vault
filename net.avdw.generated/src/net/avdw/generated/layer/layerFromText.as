package net.avdw.generated.layer
{
	...
	import net.avdw.pattern.generate.makeOverlayTextureFromPattern;
	import net.avdw.pattern.scanlinePattern;
	import net.avdw.text.loadText;
	
	public function layerFromText(width:int, height:int, codeClass:Class, textSize:int = 18):Bitmap
	{
		var textfield:TextField = new TextField();
		textfield.text = loadText(codeClass);
		...
		bmp.name = "net.avdw.background.bgFromText";
		return bmp;
	}
