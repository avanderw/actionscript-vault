package net.avdw.transition
{
	...
	import net.avdw.game.gui.GuiButton;
	import net.avdw.game.gui.GuiHorizontalGroup;
	import net.avdw.game.gui.GuiPanel;
	import net.avdw.game.gui.GuiVerticalGroup;
	...
	public class TransitionMain extends Sprite
	{
		...
		private function this_addedToStage(e:Event = null):void
		{
			...
			leftButtonGroup.add(new GuiButton("Horizontal Bars", button_onClicked, new TransitionHorizontalBars(9)));
			leftButtonGroup.add(new GuiButton("Horizontal Blinds", button_onClicked, new TransitionFade()));
			leftButtonGroup.add(new GuiButton("Horizontal Blocks", button_onClicked, new TransitionFade()));
			leftButtonGroup.add(new GuiButton("Horizontal Slide", button_onClicked, new TransitionFade()));
			leftButtonGroup.add(new GuiButton("Horizontal Zip", button_onClicked, new TransitionFade()));
			leftButtonGroup.filters = [new DropShadowFilter()];
			
			const rightButtonGroup:GuiVerticalGroup = new GuiVerticalGroup();
			rightButtonGroup.add(new GuiButton("Vertical Bars", button_onClicked, new TransitionVerticalBars(9)));
			rightButtonGroup.add(new GuiButton("Vertical Blinds", button_onClicked, new TransitionFade()));
			rightButtonGroup.add(new GuiButton("Vertical Blocks", button_onClicked, new TransitionFade()));
			rightButtonGroup.add(new GuiButton("Vertical Slide", button_onClicked, new TransitionFade()));
			rightButtonGroup.add(new GuiButton("Vertical Zip", button_onClicked, new TransitionFade()));
