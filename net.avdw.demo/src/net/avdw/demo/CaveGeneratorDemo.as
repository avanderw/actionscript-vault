package net.avdw.demo
{
	...
	import net.avdw.generated.generate.makeCave;
	import net.avdw.generated.pattern.generate.makeOverlayTextureFromPattern;
	import net.avdw.generated.pattern.*;
	import net.avdw.generated.render.renderCave;
	import net.avdw.generated.text.createTextField;
	...
	public class CaveGeneratorDemo extends Sprite
	{
		...
		public function CaveGeneratorDemo()
		{
			...
			alignHorizontalCenterVerticalMiddle(genText, stage);
