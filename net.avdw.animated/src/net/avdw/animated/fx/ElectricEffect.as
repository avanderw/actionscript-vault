 ...
 * Downloaded from: http://wonderfl.net/c/pTTT
 */

// forked from okoi's ElectricEffect
//
...
package net.avdw.fx
{
     ...
     * @author okoi
     */
    public class ElectricEffect extends Sprite 
    {
        ...
        public function ElectricEffect():void 
        {
            if (stage) init();
