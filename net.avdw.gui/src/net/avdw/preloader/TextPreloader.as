package net.avdw.preloader {
	 ...
	 */
	public class TextPreloader extends MovieClip {
		private var simulate:Boolean;
		
		public function TextPreloader(simulate:Boolean = false) {
		...
		private function startup():void {
			addChild(new TestRunner() as DisplayObject);
		}
	}
