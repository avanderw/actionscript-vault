package net.avdw.game.gui
{
	...
	public class GuiButton extends AGuiComponent
	{
		...
		public function GuiButton(label:String, callback:Function = null, payload:Object = null)
		{
			...
			titleText.defaultTextFormat = new TextFormat(null, 13, 0xFFFFFF, null, null, null, null, null, TextFormatAlign.CENTER);
			titleText.selectable = false;
			titleText.text = label;
			titleText.width = _width;
			titleText.height = 18;
			addChild(titleText);
